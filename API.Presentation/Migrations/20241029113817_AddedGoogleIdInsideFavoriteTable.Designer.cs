...
namespace API.Presentation.Migrations
{
    ...
    [Migration("20241029113817_AddedGoogleIdInsideFavoriteTable")]
    partial class AddedGoogleIdInsideFavoriteTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Domain.Favorite.FavoritePlace", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "6b0a38d1-71ad-4628-80c8-88beb6251929",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Entities.Domain.Google.Date", b =>
                {
                    b.HasOne("Entities.Domain.Google.Close", null)
                        .WithOne("Date")
                        .HasForeignKey("Entities.Domain.Google.Date", "CloseId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
